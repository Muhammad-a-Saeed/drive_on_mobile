...
const BarDot = ({
  ...
  return (
    <View
      style={
        isActive
          ? [styles.barDotActive, {backgroundColor: color1}, activeDotStyle]
          : [styles.barDotInactive, {backgroundColor: color2}, inActiveDotStyle]
      }
    />
  );
};
...
const CircleDot = ({
  ...
  return (
    <View
      style={
        isActive
          ? [styles.circleDotActive, {backgroundColor: color1}, activeDotStyle]
          : [
              styles.circleDotInactive,
...
const styles = StyleSheet.create({
  ...
  barDotActive: {width: 25, height: 10, borderRadius: 100},
